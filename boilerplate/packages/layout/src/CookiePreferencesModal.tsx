...
import { useConsent, type ConsentLevel } from './GdprBanner';
 ...
 * Uses the same useConsent hook as GdprBanner for consistency.
 */
export function CookiePreferencesModal({ isOpen, onClose }: CookiePreferencesModalProps) {
  ...
  // Sync selection when consent level changes externally
  useEffect(() => {
        ...
        >
          ...
          <div className="p-4 space-y-4">
            <p className="text-sm text-gray-600 dark:text-gray-300">
              {t('cookies.preferencesDescription', 'Choose which cookies you want to accept. Your choice will be saved and applied immediately.')}
            </p>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    {t('cookies.essentialDescription', 'Required for authentication and basic functionality. Cannot be disabled.')}
                  </p>
                </div>
                <div className="ml-4">
            ...
            <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    {t('cookies.optionalDescription', 'Help us improve the site and provide personalized content and relevant advertisements.')}
                  </p>
                </div>
                <div className="ml-4">
                  <button
